...
words = {'Colors':'red orange yellow green blue indigo violet white black brown'.split(),
                ...
                'Animals':'''bat bear beaver cat cougar crab deer dog donkey duck eagle 
                             ...
                             whale wolf wombat zebra'''.split()}#turned strings into list items

def get_word(): # chose a random word
    chosen_key = random.choice(list(words.keys()))
    chosen_value = random.choice(words[chosen_key])
##    print("Key = ",chosen_key, "Value = ", chosen_value)
    return chosen_key, chosen_value

def display_intro(secret_word,correct_guess,missed_guess,secret_set):
...
correct_guess = ''
missed_guess = ''
secret_set, secret_word = get_word()
display_intro(secret_word,correct_guess,missed_guess,secret_set)
game_is_done = False
